...
export const publicCrawlersRowSchema = z.object({
  active: z.boolean(),
  bays: jsonSchema.nullable(),
  cargo: jsonSchema.nullable(),
  choices: jsonSchema.nullable(),
  crawler_type_id: z.string().nullable(),
...
export const publicCrawlersInsertSchema = z.object({
  ...
  bays: jsonSchema.optional().nullable(),
  cargo: jsonSchema.optional().nullable(),
  choices: jsonSchema.optional().nullable(),
  crawler_type_id: z.string().optional().nullable(),
...
export const publicEntitiesRowSchema = z.object({
  crawler_id: z.string().nullable(),
  created_at: z.string(),
  id: z.string(),
  mech_id: z.string().nullable(),
...
export const publicEntitiesInsertSchema = z.object({
  crawler_id: z.string().optional().nullable(),
  created_at: z.string().optional(),
  id: z.string().optional(),
  mech_id: z.string().optional().nullable(),
...
export const publicEntitiesUpdateSchema = z.object({
  crawler_id: z.string().optional().nullable(),
  created_at: z.string().optional(),
  id: z.string().optional(),
  mech_id: z.string().optional().nullable(),
...
export const publicEntitiesRelationshipsSchema = z.tuple([
  z.object({
...
export const publicMechsRowSchema = z.object({
  ...
  cargo: jsonSchema.nullable(),
  chassis_ability: z.string().nullable(),
  chassis_id: z.string().nullable(),
  choices: jsonSchema.nullable(),
  created_at: z.string().nullable(),
  current_damage: z.number().nullable(),
...
export const publicMechsInsertSchema = z.object({
  ...
  cargo: jsonSchema.optional().nullable(),
  chassis_ability: z.string().optional().nullable(),
  chassis_id: z.string().optional().nullable(),
  choices: jsonSchema.optional().nullable(),
  created_at: z.string().optional().nullable(),
  current_damage: z.number().optional().nullable(),
...
export const publicPilotsRowSchema = z.object({
  ...
  active: z.boolean(),
  advanced_class_id: z.string().nullable(),
  appearance: z.string().nullable(),
  ...
  legendary_ability_id: z.string().nullable(),
...
export const publicPilotsInsertSchema = z.object({
  ...
  active: z.boolean().optional(),
  advanced_class_id: z.string().optional().nullable(),
  appearance: z.string().optional().nullable(),
  ...
  legendary_ability_id: z.string().optional().nullable(),
...
export const publicPlayerChoicesRelationshipsSchema = z.tuple([
  z.object({
    ...
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("entities"),
    referencedColumns: z.tuple([z.literal("id")]),
  }),
]);
