...
const COMMON_SCHEMA_PATH = path.join(
  __dirname,
  '../schemas/shared/common.schema.json'
)
...
async function generateCommonTypes() {
  console.log(
    '🔧 Generating TypeScript common types from common.schema.json...\n'
  )
  ...
  console.log(
    `📊 Generated ${baseTypes.length + dependentTypes.length} common types`
  )
}
