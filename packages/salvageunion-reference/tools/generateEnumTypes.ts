...
const ENUMS_SCHEMA_PATH = path.join(
  __dirname,
  '../schemas/shared/enums.schema.json'
)
...
async function generateEnumTypes() {
  console.log('🔧 Generating TypeScript enum types from enums.schema.json...\n')
  ...
  console.log(`📋 Found ${enumNames.length} enum definitions:`)
  ...
  console.log('✅ Enum types generated successfully!')
  console.log(`📄 Output: ${OUTPUT_FILE}`)
  console.log(`📊 Generated ${enumNames.length} enum types`)
}

// Run the generator
generateEnumTypes().catch((error) => {
  console.error('❌ Enum type generation failed:', error)
  process.exit(1)
})
