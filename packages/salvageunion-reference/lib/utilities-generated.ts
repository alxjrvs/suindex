 ...
 */
export function isAbilityTreeRequirement(entity: SURefMetaEntity): entity is SURefMetaAbilityTreeRequirement {
  return (
    'id' in entity &&
    'name' in entity &&
    'source' in entity &&
 ...
 */
export function getBonusPerTechLevel(entity: SURefMetaEntity): SURefObjectBonusPerTechLevel | undefined {
